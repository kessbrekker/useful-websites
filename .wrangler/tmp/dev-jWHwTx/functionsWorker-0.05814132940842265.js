...
// .wrangler/tmp/bundle-hAh5CY/checked-fetch.js
...
// .wrangler/tmp/bundle-hAh5CY/strip-cf-connecting-ip-header.js
...
// .wrangler/tmp/pages-5U0nPY/functionsWorker-0.05814132940842265.mjs
...
var JWTClaimsBuilder = /* @__PURE__ */ __name(class {
  #payload;
  constructor(payload) {
    if (!isObject(payload)) {
...
__name2(JWTClaimsBuilder, "JWTClaimsBuilder");
...
var SignJWT = /* @__PURE__ */ __name(class {
  #protectedHeader;
  #jwt;
  constructor(payload = {}) {
...
var jsonResponse = /* @__PURE__ */ __name2((data, status = 200) => {
...
var hashPassword = /* @__PURE__ */ __name2(async (password) => {
  ...
  const derivedBits = await crypto.subtle.deriveBits(
    { name: "PBKDF2", salt: ENCODING.encode(salt), iterations: 1e5, hash: "SHA-256" },
    keyMaterial,
    256
  );
  const hashFn = /* @__PURE__ */ __name2((buf) => Array.from(new Uint8Array(buf)).map((b) => b.toString(16).padStart(2, "0")).join(""), "hashFn");
  return `${salt}.${hashFn(derivedBits)}`;
}, "hashPassword");
var comparePassword = /* @__PURE__ */ __name2(async (password, storedUrl) => {
...
var getUserFromRequest = /* @__PURE__ */ __name2(async (request, secret) => {
...
var fetchWebsiteMetadata = /* @__PURE__ */ __name2(async (targetUrl) => {
  try {
...
var onRequestPost = /* @__PURE__ */ __name2(async (context) => {
  ...
  if (!website_id)
    return jsonResponse({ error: "Website ID required" }, 400);
...
var onRequestPost2 = /* @__PURE__ */ __name2(async (context) => {
  ...
  if (url.pathname.endsWith("/register")) {
    ...
    const result = await env.DB.prepare("INSERT INTO users (email, password_hash, is_admin) VALUES (?, ?, ?)").bind(email, hash, isAdmin).run();
    if (!result.success)
...
// .wrangler/tmp/bundle-hAh5CY/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-hAh5CY/middleware-loader.entry.ts
...
//# sourceMappingURL=functionsWorker-0.05814132940842265.js.map
